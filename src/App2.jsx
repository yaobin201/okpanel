...
export default function Example() {
  ...
  function formatViewTypeName() {
    if (viewType === 'profile') {
      ...
      const dataInfo = navigation.find(item => item.id === viewType)
      return dataInfo.cat;
    }
  }
  ...
  function renderSubItem(source) {
    return (
      <div className='border border-slate-200 border-solid bg-white rounded-md p-4'>
  ...
  return (
    <>
      <div className="h-screen min-h-full w-screen">
                ...
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <span className='text-2xl text-white'>Fast Start</span>
                    </div>
